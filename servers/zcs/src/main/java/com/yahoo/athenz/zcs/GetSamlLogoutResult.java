...
public final class GetSamlLogoutResult {
    private ResourceContext context;
    private int code; //normal result

    GetSamlLogoutResult(ResourceContext context) {
    ...
    public void done(int code, SamlLogout samlLogout, String location) {
        Response resp = Response.status(code).entity(samlLogout)
